...
-- ----------------------------
-- Table structure for LOGIN_SWITCH
-- ----------------------------
DROP TABLE IF EXISTS `LOGIN_SWITCH`;
CREATE TABLE `LOGIN_SWITCH`  (
...
INSERT INTO `LOGIN_SWITCH`(`MODEL_NAME`,  `DELETE_FLAG`, `CREATE_USER`, `UPDATE_USER`, `CREATE_TIME`, `UPDATE_TIME`) VALUES ( '/login', '0', 1, NULL, '2019-09-23 19:25:01',NULL);
