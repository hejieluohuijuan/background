...
INSERT INTO `hzw_bk`.`SYS_USER`(`ID`, `USER_NAME`, `NAME`, `PASSWORD`, `DELETE_FLAG`, `CREATE_USER`, `UPDATE_USER`, `CREATE_TIME`, `UPDATE_TIME`) VALUES (1, 'admin', 'hj', '123456', NULL, NULL, NULL, '2019-09-23 19:25:01',NULL);
